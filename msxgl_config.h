...
#define DOS_USE_ERROR_HANDLER		TRUE	// Add support for error handler callback
...
#define GAME_USE_SYNC_50HZ			FALSE	// Force 50Hz synchronization on 60Hz machine
...
#define MENU_FRAME_Y				11		// Frame position Y
...
#define MENU_ITEM_Y					11		// Item label X position
