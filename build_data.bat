...
%MSXtk%\MSXimg.exe datasrc\logo.png  -out content\data_logo.h    -mode gm2   -compress rlep	-name g_DataLogo    -pos 32 16 -size 152 80  -offset 0
echo %errorlevel%
                                                                                                            
%MSXtk%\MSXimg.exe datasrc\court.png -out content\data_court.h   -mode gm2   -compress rlep	-name g_DataCourt   -pos 24 24 -size 216 144 -offset 0
echo %errorlevel%

%MSXtk%\MSXimg.exe datasrc\score.png -out content\data_board.h   -mode gm2   -compress rlep	-name g_DataScore   -pos 0 0   -size 216 80  -offset 160 ^
	-l gm2 0 88 112 96 ^
	-l gm2 112 80 72 24 ^
	-l gm2 184 80 72 24 ^
	-l gm2 112 104 72 16 ^
...
%MSXtk%\MSXimg.exe datasrc\font.png -out content\data_font.h    -pos 0 0   -size 8 8 -gap 0 0 -num 16 4 -trans 0x000000 -bpc 1 -name g_DataFont    -font 8 8 ! _ -skip

%MSXtk%\MSXimg.exe datasrc\misc.png -out content\data_scrfont.h -pos 0 136 -size 8 8 -gap 0 0 -num 15 1 -trans 0x000000 -bpc 1 -name g_DataSrcFont -font 8 8 0 0x3E

echo.
echo -----------------------------------------------------------------------------
echo  Convert Sprites...

%MSXtk%\MSXimg.exe datasrc\misc.png    -out content\data_net.h     -mode sprt -name g_DataNet     -pos 0 200 -size 16 16 -num 5 1 -l i16 0 0 1 1 0xFFFFFF 0xCCCCCC

%MSXtk%\MSXimg.exe datasrc\misc.png    -out content\data_points.h  -mode sprt -name g_DataPoints  -pos 0 232 -size 16 16 -num 8 1 -l i16 0 0 1 1 0xFFFFFF

%MSXtk%\MSXimg.exe datasrc\misc.png    -out content\data_event.h   -mode sprt -name g_DataEvent   -pos 0 248 -size 16 16 -num 6 3 -l i16 0 0 1 1 0xFFFFFF

%MSXtk%\MSXimg.exe datasrc\misc.png    -out content\data_racket.h  -mode bmp  -name g_DataRacket  -pos 128 200 -size 8 8 -num 3 1  -bpc 1 -trans 0xFF897D

%MSXtk%\MSXimg.exe datasrc\misc.png    -out content\data_ball.h    -mode bmp  -name g_DataBall    -pos 128 192 -size 8 8 -num 10 1 -bpc 1 -trans 0xFF897D

%MSXtk%\MSXimg.exe datasrc\misc.png    -out content\data_cup.h     -mode bmp  -name g_DataCup     -pos 128 208 -size 8 8 -num 6 1  -bpc 1 -trans 0xFF897D

%MSXtk%\MSXimg.exe datasrc\misc.png    -out content\data_cursor.h  -mode sprt -name g_DataCursor  -pos 128 232 -size 16 16 -num 3 1 -l i16 0 0 1 1 0x5955E0
